...
<body>
	<div class="row">
		<form class="form-Registro col-sm-12 col-md-12 col-lg-12"
			method="POST" action="menuController?action=register">
			<div class="infoCamposTexto col-sm-12 col-md-12 col-lg-12">Nombre:</div>
			<div class="col-sm-12 col-md-12 col-lg-12">
				<input class="campo-texto" type="text" name="nombreRegistro"
					required="required">
			</div>
			<div class="infoCamposTexto col-sm-12 col-md-12 col-lg-12">Email:</div>
			<div class="col-sm-12 col-md-12 col-lg-12">
				<input class="campo-texto" type="text" name="mailRegistro"
					required="required">
			</div>
			<div class="infoCamposTexto col-sm-12 col-md-12 col-lg-12">Password:</div>
			<div class="col-sm-12 col-md-12 col-lg-12">
				<input class="campo-texto" type="text" name="passwordRegistro"
					required="required">
			</div>
			<div class="col-sm-12 col-md-12 col-lg-12">
			...
			<div class="col-sm-12 col-md-12 col-lg-12">
				<a class="linkRegistro" href="menuController?action=login">¿No
