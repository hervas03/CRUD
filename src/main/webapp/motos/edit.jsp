...
<body>
	...
	<%
	//le paso el valor del atributo mot el cual se llena en el controlador
	Motos moto = (Motos) request.getAttribute("mot");
	%>
	<div class="row">
		<form class="form-create-mot col-sm-12 col-md-12 col-lg-12"
			method="POST" action="MotosController?action=update">
			<input type="hidden" name="idEdit" value="<%=moto.getId()%>">
			<div class="infoCamposTexto col-sm-12 col-md-12 col-lg-12">Marca:</div>
			<div class="col-sm-12 col-md-12 col-lg-12">
				<!-- Le paso este valor al controlador por la etiqueta name -->
